...
public class DTOMapperImpl implements DTOMapper {
    ...
    @Override
    public LendingDetailDTO toLendingDetail(Lending lending) {
        if ( lending == null ) {
            return null;
        }
    ...
    protected Set<LendingDetailDTO> lendingListToLendingDetailDTOSet(List<Lending> list) {
        ...
        for ( Lending lending : list ) {
            set.add( toLendingDetail( lending ) );
        }
    ...
    protected VehicleListDTO vehicleToVehicleListDTO(Vehicle vehicle) {
        ...
        vehicleListDTO.setCurrentLending( toLendingDetail( vehicle.getCurrentLending() ) );
        vehicleListDTO.setLendings( lendingListToLendingDetailDTOSet( vehicle.getLendings() ) );
